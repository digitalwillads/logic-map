      ...
      <div className="doc-scroll">
        ...
        <section className="doc-section">
          ...
          <p className="doc-section-desc">
            Rules that are always true across the entire system.
          </p>
          <div className="doc-invariants">
        ...
        <section className="doc-section">
          <h2>Entities</h2>
          <p className="doc-section-desc">
            The core data objects in the system.
          </p>
        ...
        <section className="doc-section">
          ...
          {logicMap.systems.map((system) => {
            ...
            // Find relationships involving this system
